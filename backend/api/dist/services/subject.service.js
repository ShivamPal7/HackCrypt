...
exports.deleteSubject = exports.getSubjects = exports.updateSubject = exports.getSubject = exports.createSubject = void 0;
...
const getSubjects = async (institutionId) => {
    return await prisma_1.default.subject.findMany({
        where: { institutionId },
        include: { lectures: true }
    });
};
