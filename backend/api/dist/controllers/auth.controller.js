...
exports.getMe = exports.refresh = exports.webLogin = exports.login = exports.webRegister = exports.sendOtp = exports.create = void 0;
...
const sendOtp = async (req, res, next) => {
    ...
    (0, response_1.sendResponse)(res, 200, 'OTP sent', result);
};
exports.sendOtp = sendOtp;
const webRegister = async (req, res, next) => {
    const result = await authService.webRegister(req.body);
    (0, response_1.sendResponse)(res, 201, 'Teacher registered successfully', result);
};
...
const webLogin = async (req, res, next) => {
    ...
    (0, response_1.sendResponse)(res, 200, 'Web Login successful', result);
};
